...
- API version: 0.3.0
- Build date: 2026-09-07T14:48:23.368694+09:00[Asia/Tokyo]
- Generator version: 7.24.0



This autogenerated project defines an API crate `galerie_api` which contains:
...
#[async_trait]
impl galerie_api::apis::default::Api for ServerImpl {
  // API implementation goes here
}

impl galerie_api::apis::ErrorHandler for ServerImpl {}
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = galerie_api::server::new(Arc::new(ServerImpl));
