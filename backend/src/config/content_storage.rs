...
/// Represents the configuration for content storage
...
#[derive(Debug, Deserialize)]
/// Represents the configuration for file system content storage
...
#[derive(Debug, Deserialize)]
/// Represents the configuration for S3 content storage
